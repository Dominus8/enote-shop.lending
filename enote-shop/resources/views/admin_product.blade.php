...
<div class="admin-content-wrapper">
    ...
    <div class="category-management">
        ...
        @foreach($category as $el)
            <p>{{$el->category_name}}&nbsp{{$el->id}} <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editCat{{$el->id}}">изменить</button><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#dellCat{{$el->id}}">удалить</button></p>
              ...
              <div class="modal fade" id="dellCat{{$el->id}}" tabindex="-1" role="dialog" aria-labelledby="dellCat{{$el->id}}Title" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Отмена</button>
                      <a href="/category_remote/{{$el->id}}" type="button" class="btn btn-primary">Удалить</a>
                    </div>
                  </div>
                </div>
              </div>
